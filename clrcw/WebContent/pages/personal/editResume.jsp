...
function checkform(){
	...
	if (level.search(/^[0-9a-zA-Z\u4e00-\u9FA5]+$/) < 0 && level != "") {
		alert("计算机水平包含非法字符");
		document.UpdateResumeForm.level.focus();
		return false;
	}
		...
		--><div id="main">
			...
			<div id="content">
				...
				<DIV class="formdiv"
					...
					<html:form action="/updateResume.do?method=updateResume"
						...
						<table class="finktable" id="jbqk" summary="个人招聘信息" width="100%"
							...
							<tr>
								...
								<td width="33%" rowspan="5" class="black">
									...
									%>
									<html:img action="photo.do?method=photo" width="200"
										height="200" />
									<%
										} else {
									%>
...
<tr>
								...
								<td class="black">
									<select name="dkind" id="dkind" title="请选择残疾类别">
										<%
											String dkind=personResume.getDkind().trim();
								...
								<tr>
									...
									<td colspan="4" height="35" align="center">
										...
										<input type="button" name="btn1" value="返回"
											onClick="window.location.href='${ctx}/personRegist3.do?method=personRegist3'"
											class="input4">
									</td>
								</tr>
						</table>
