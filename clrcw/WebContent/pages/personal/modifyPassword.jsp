...
<div id="content">
    	<h2>个人用户【${personUserId}】信息&nbsp;&nbsp;    &nbsp;&nbsp;<a href="javascript:history.back();" style="color:#BD0403;">[返回]</a><a href="${ctx}/logout.do?method=logout" style="color:#BD0403;">[退出]</a></h2>
        <div class="formdiv"  align="center">
						...
						<form
							action="${ctx}/modifyPassword.do" method="post"
