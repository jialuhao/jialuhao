...
if(b){
window.location.href="${ctx}/personRegist8.do?method=toUpdateEducation&id="+s_id;
}
}else{
window.location.href="${ctx}/personRegist8.do?method=toUpdateEducation&id="+s_id;}		
}
			...
			<div id="content">
				...
				<DIV class="formdiv"
					...
					<ul id="list1">
						...
						<li>
							<a href="${ctx}/personRegist9.do?method=showAll">&equiv;&nbsp;
								职位搜索</a>
						</li>
						<!-- li>
				...
				<DIV class="formdiv"
					...
					<form action="${ctx}/personRegist8_1.do?method=delPersonEducation" name="form1"
						method="POST">
						<table class="finktable" id="jbqk" summary="个人招聘信息">
							...
							<%
							 String notapply=(String)request.getAttribute("notapply");
								List list = (List) request.getAttribute("education");
							...
							<tr>
								...
								<td width="148" style="color: #000000; font-size: 12px;"
									nowrap="nowrap" align="center">
									<a   href="#"  onclick="edit('<%=personEducation.getId()%>','${notapply}')"
										
										class="tabBtn">编辑</a>
									<a href="#" onClick="del('<%=personEducation.getId()%>','${notapply}')"
										class="tabBtn">删除</a>
								</td>
							</tr>
					...
					<form name="form2"
						action="${ctx}/personRegist8_1.do?method=personRegist8_1"
