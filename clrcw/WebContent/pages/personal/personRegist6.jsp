...
$(function(){
	...
	title: '选择行业',
	lock: true ,
    content: 'url:showTradeall.do?method=showTradeAll'
	});
});
$(function(){
	...
	title: '选择职业',
	lock: true,
    content: 'url:showJoball.do?method=showJobAll'
	});
});
...
$(function(){
	...
	title: '选择区域',
	lock: true,
    content: 'url:showQuyuall.do?method=showQuyuAll'
	});
});
		...
		--><div id="main">
			<div id="content">
				...
				<DIV class="formdiv"
					...
					<form action="${ctx}/delApply.do?method=delApply" name="form1" method="post">
						<TABLE class="finktable" id="jbqk" width="100%" border="0"
							...
							<TR>
								...
								<%     
									List vvv = (List) request.getAttribute("allapply");
							...
							<tr>
								...
								<td align="center" style="color: #000000; font-size: 12px;">
									<a
										href="${ctx}/showOneApplyJob.do?method=showOneApplyJob&apllyId=<%=applyJobInfo.getId()%>"
										 class="tabBtn">编辑</a>
					...
					<form name="form2"
						action="${ctx}/personRegist6.do?method=personRegist6"
