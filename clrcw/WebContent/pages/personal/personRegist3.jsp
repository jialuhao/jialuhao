...
if(a!='notapply'){
 b = confirm("修改后您的简历信息将进入待审核状态");
 if(b){
 window.location.href="${ctx}/resume.do?method=resume";
 }
 }else{
 window.location.href="${ctx}/resume.do?method=resume";
 }
			...
			<div id="content">
				...
				<div class="formdiv"
					...
					<ul id="list1">
						...
						<li>
							<a href="${ctx}/personRegist4.do?method=personRegist4">&equiv;&nbsp;工作/实习经历
							</a>
						</li>
						<li>
						...
						<li> <a href="${ctx}/personRegist9.do?method=showAll" >&equiv;&nbsp;职位搜索</a></li>
              <!-- li> <a href="${ctx}/personShowCompInfo.do?method=showCompInfo" >8. 企业招聘意向</a></li-->
					</ul>
					<div style="height: 1px; background: #ededed; width: 100%; clear:both; font-size:0;line-height:0;"></div>
				</div>
				<DIV class="formdiv"
						...
						<table class="finktable" id="jbqk" summary="个人招聘信息" width="100%"
							...
							<TBODY>
								<tr>
									...
									<td width="33%" rowspan="5" class="black">
										<%
											if (request.getAttribute("version").equals("true")) {
										%>
								...
								<tr>
									...
									<td class="black"><%=personResume.getCardnumber()%>
									</td>
								</tr>
								<tr>
									<td>
							  ...
							  <tr>
								...
								<tr>
									<td colspan="4" align="center">
										<a href="javascript:modify('${notapply}')"   ><img src="/clrcw/image/change.gif"
											alt="修改" /></a>
										<a href="${ctx}/personRegist8.do?method=personRegist8"><img
