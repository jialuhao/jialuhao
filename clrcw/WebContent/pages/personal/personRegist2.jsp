...
<script language="JavaScript" type="text/JavaScript">
	function checkform() {
		...
		truename = document.PersonRegist2Form.truename.value;
		years = document.PersonRegist2Form.years.value;
		otherparts = document.PersonRegist2Form.otherparts.value;
		skill= document.PersonRegist2Form.skill.value;
		level = document.PersonRegist2Form.level.value;
		language = document.PersonRegist2Form.language.value;
		languagelevel = document.PersonRegist2Form.languagelevel.value;
		language2 = document.PersonRegist2Form.language2.value;
		languagelevel2 = document.PersonRegist2Form.languagelevel2.value;
		language3 = document.PersonRegist2Form.language3.value;
		languagelevel3 = document.PersonRegist2Form.languagelevel3.value;
		cardnumber=document.PersonRegist2Form.cardnumber.value;
		...
		document.PersonRegist2Form.parts.value = partvalues;
		if (truename.length > 10 || truename.length <= 0) {
			alert("真实姓名长度必须小于10个字");
			document.PersonRegist2Form.truename.focus();
			return false;
		}
		if (truename.search(/^[\u4e00-\u9FA5]+$/) < 0
			...
			alert("身份证不能为空");
			document.PersonRegist2Form.cardnumber.focus();
			return false;
		}
		...
		if (level.length > 40) {
			...
			document.PersonRegist2Form.level.focus();
			return false;
		}
		
		if (language.length > 40) {
			alert("外语语种长度必须小于40个字");
			document.PersonRegist2Form.language.focus();
			return false;
		}
		...
		if (language2.length > 40) {
			alert("外语语种长度必须小于40个字");
			document.PersonRegist2Form.language2.focus();
			return false;
		}
		...
		if (language3.length > 40) {
			alert("外语语种长度必须小于40个字");
			document.PersonRegist2Form.language3.focus();
			return false;
		}
		...
		if (languagelevel.length > 40) {
			...
			document.PersonRegist2Form.languagelevel.focus();
			return false;
		}
		if (languagelevel2.length > 40) {
			alert("外语水平长度必须小于40个字");
			document.PersonRegist2Form.languagelevel2.focus();
			return false;
		}
		if (languagelevel3.length > 40) {
			alert("外语水平长度必须小于40个字");
			document.PersonRegist2Form.languagelevel3.focus();
			return false;
		}
		...
		if (skill.length <=0||skill.length>200) {
			...
			document.PersonRegist2Form.skill.focus();
			return false;
		}
		nowadd = document.PersonRegist2Form.nowadd.value;
		postcode = document.PersonRegist2Form.postcode.value;
		telnum = document.PersonRegist2Form.telnum.value;

		if (nowadd.length > 50 || nowadd.length <= 0) {
			alert("地址长度为0-50个字");
			document.PersonRegist2Form.nowadd.focus();
			return false;
		}
		...
		if (postcode.length != 6) {
			alert("邮编长度为6位数字");
			document.PersonRegist2Form.postcode.focus();
			return false;
		}
		...
		if (telnum.length<6||telnum.length>15) {
			...
			document.PersonRegist2Form.telnum.focus();
			return false;
		}
	...
	var img = null;
	function getsize() {
		var local = document.PersonRegist2Form.uploadphoto.value;
		...
		if (local == "") {
			document.PersonRegist2Form.submit();
			return true;
		}
		if (type == "") {
			return true;
		...
		<div id="container">
			...
			--><div id="main">
				<div id="content">
					...
					<div class="formdiv">
						<html:form action="/personRegist2.do?method=personRegist2" method="post" enctype="multipart/form-data">
							<table class="finktable" id="jbqk" summary="个人招聘信息" width="100%" >
								...
								<tr>
									...
									<td width="33%">
										<input type="text" Class="input3" id="truename" value="${s_name}"
								...
								<tr>
								<td>
								<%String desc=(String)request.getSession().getAttribute("dcsid");
							
								if(desc!=null){
								 desc=desc.substring(0,18);}else{
								 desc="";
								 }
								 %>
										<label for="birthday">
									...
									<td>
										<input type="text" Class="input3" id="cardnumber" 
											name="cardnumber" value="<%=desc%>" title="请输入身份证号" />
									<%String  aaa="";
									if(request.getAttribute("shenfenzheng")!=null){
									aaa=(String)request.getAttribute("shenfenzheng");
									} %>
									
										<font color="red"><%=aaa%></font>
										<br/>
										<font color="#333333" style="font-size: 12px;">*身份证号为18位</font>
									</td>
									</tr>
								<tr>
									<td>
...
<%if("2".equals(session.getAttribute("red_add"))){%>
											<option>
												外埠
											</option>
											<% }else if("1".equals(session.getAttribute("red_add"))){%>
