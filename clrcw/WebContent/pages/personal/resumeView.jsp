...
var nowtime = new Date();
    ...
    var oDate2= a.substring(0,10).split(strSeparator);
   var strDateE = new Date(oDate2[0], oDate2[1]-1, oDate2[2]);
var iDays = parseInt(Math.abs(nowtime - strDateE ) / 1000 / 60 / 60 /24);
if(iDays<7){
alert("一周之内不能重复置顶");
}else{
window.location.href="${ctx}/postResume.do?method=refresh";
alert("置顶成功");}
}
</script>
	</head>
			...
			<div id="main">
				<div id="content">
					...
					<%
								...
								timee=applyJob.getRefreshtime();
								
								%>
					
				
						<div align="right"><button name="button" class="input8" 
						onclick="shuaxin('<%=timee%>')" id="button">
										简历置顶
									</button></div>
						<% }%>
	<div class="formdiv">
