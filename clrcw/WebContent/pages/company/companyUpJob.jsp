...
if(address.length>100){
 ...
 var d=confirm("修改后此条招聘信息将进入待审核状态");
    if(!d){
    return false;
    }
						...
						<table class="finktable" summary="企业招聘信息">
							...
							<tr>
								...
								<td width="270" class="font5" title="请选择招聘职位">
									...
									<html:select property="jobId" value="${oneJob.job.id}">
							...
							<tr>
								...
								<td>
									...
									<html:select property="money" value="${oneJob.salary}">
							...
							<tr>
								...
								<td>
									<span class="font5"> 
									<bean:define id="areas" name="arealist" type="java.util.List" />
									<html:select property="workarea" value="${oneJob.workarea}">
										<html:options collection="areas" property="areaname" 
