...
function del(id){
    ...
    if (b) {
        ...
        document.form1.action = "${ctx}/companyQueryContact.do?method=delOneResume";
        document.form1.submit();
    }
}
function change(s_id){
    document.form1.pageIndex.value = s_id;
    document.form1.action = "${ctx}/companyQueryContact.do?method=comOtherPage";
    document.form1.submit();
    }
function checkresume(a,b,c){
if(c){
window.location.href="${ctx}/companyQueryContact.do?method=showOneResume&userKeyId="+a+"&compResumekeyId="+b;}
else{
										...
										<tr>
											...
											<td width="25%">
												...
												<a
													...
													class="d"  style="color: #BD0403;">已读简历 </a>
											</td>
										</tr>
									</table>
								</td>
									...
									<logic:iterate name="allResume" id="jobInfo"
										...
										<tr>
											...
											<td align="center">
												<a
													href="#"
												onclick="checkresume('${jobInfo.pkResume.user.id}','${jobInfo.id}',${jobInfo.reg})"	class="d"> 查看</a>&nbsp;
												<a href="#" onClick="del(${jobInfo.id})" class="d">删除</a>
											</td>
										</tr>
									</logic:iterate>
