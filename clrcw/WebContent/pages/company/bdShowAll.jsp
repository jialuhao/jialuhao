  ...
  <tr>
    <td valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
                  ...
                  <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                    <tr>
                      <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <TABLE width="60%" border="0" align="center" cellPadding="0" cellSpacing="0" id="table3">
                        <TBODY>
                      	<logic:present name="allPost">
                      		<logic:notEmpty name="allPost">
                      		<%
                      			List<BdPostRoot> list=(List<BdPostRoot>)request.getAttribute("allPost");
                      		 for(int i = 0;i < list.size();i++) 
                            { 
                            if   (i==0) 
                            { 
                            %> 
                              <tr> <td width="50%"><A href=#<%=i%> class="d"> <%=list.get(i).getPostName()%></A> </td> 
                            <% 
                            } 
                            else if   (i%2==0) 
                            { 
                            ...
                            <A href=#<%=i%> class="d"><%=list.get(i).getPostName()%></A> </td> 
                            <% 
                            } 
                           else 
                            { 
        ...
        <logic:present name="allPost">
             <logic:notEmpty name="allPost">
                 <logic:iterate id="postRootAll" name="allPost" type="model.BdPostRoot" indexId="index">
                          ...
                          <tr>
                            <td><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  ...
                                  <a name="<%=index%>"><bean:write name="postRootAll" property="postName"/></a></td>
                                  <td width="50" align="center" valign="top" bgcolor="#779DCC" class="font4"><a href="#top" class="e">Top</a></td>
                                </tr>
                            </table></td>
                          </tr>
                          <tr>
            	 ...
            	 <bean:define id="bbPost" name="postRootAll" property="bdPosts"/>
					
                   <TABLE width="90%" border="0" align="center" cellPadding="0" cellSpacing="0" id="table">
                      <logic:present name="bbPost">
						<logic:notEmpty name="bbPost">
                              <TBODY>
                                <%
                                Set<model.BdPost> set=(Set<model.BdPost>)bbPost;
                              BdPost[] bb =set.toArray(new BdPost[0]);
                      		 for(int j = 0;j < bb.length;j++) 
                            { 
                            if   (j==0) 
                            { 
                            %> 
                              <tr> <td width="30%" class="font5"><%=bb[j].getPostName()%></td> 
                            <% 
                            } 
                            else if   (j%3==0) 
                            { 
                        ...
                        <logic:empty name="bbPost">
							<tr>
								<td colspan="3" bgcolor="#FFFFFF" class="font5" align="center">没有相关职位!</td>
							</tr>
						</logic:empty>
                    </logic:present>
        	        <logic:notPresent name="bbPost">
						<a href="${ctx}/pages/index.jsp" class="list">数据出错，请重试！</a>
					</logic:notPresent>
