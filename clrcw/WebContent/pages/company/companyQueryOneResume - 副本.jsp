...
<table width="656" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
 	...
 	<logic:present name="Resumestatus">
		<logic:equal name="Resumestatus" value="0">
	<td height="40" align="center">
		<html:link href="${ctx}/companyQueryNotContact.do?method=contact" styleClass="d">
			<span class="font10">[建立联系]</span>
		</html:link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
		<a href="#" Class="d" onClick="history.back();return false;" >
			<span class="font10">[返回]</span></a>
	</td>
	</logic:equal>
	<logic:notEqual name="Resumestatus" value="0">
		<td height="40" align="center">
		<a href="#" Class="d" onClick="history.back();return false;" >
			<span class="font10">[返回]</span></a>
	</logic:notEqual>
	</logic:present>
	<logic:notPresent name="Resumestatus">
	</logic:notPresent>
