...
<logic:present name="allPost">
	<logic:iterate  id="root" name="allPost">
<table width="300" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#cccccc">
	...
	<tr>
		...
		<bean:write name="root" property="postName"/>如下：
		</td>
	
	</tr>
	<bean:define id="bbPost" name="root" property="bdPosts"/>
	<logic:present name="bbPost">
		<logic:notEmpty name="bbPost">
		</logic:notEmpty>
			<logic:iterate id="BP" name="bbPost" type="model.BdPost">
				<tr>
