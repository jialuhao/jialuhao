...
<body>
	<div id="container">
		...
		<div id="main">
			...
			招聘成功/招聘失败：
				<select id="validflag" name="validflag" disabled="true" >
					...
					<option  <%if(request.getAttribute("flag")!=null&&request.getAttribute("flag").equals("3")){%>selected="selected"<%} %>>招聘成功</option>  
  					<option  <%if(request.getAttribute("flag")!=null&&request.getAttribute("flag").equals("2")){%>selected="selected"<%} %> >招聘失败</option>
    			</select>
    			<% if(request.getAttribute("flag")!=null&&request.getAttribute("flag").equals("3")){%> 
     ...
     <%} %>
     <%if(request.getAttribute("flag")!=null&&request.getAttribute("flag").equals("2")){
    List list=(List)request.getAttribute("list");
