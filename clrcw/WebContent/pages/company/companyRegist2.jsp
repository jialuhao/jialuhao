...
function checkform(){
    ...
    if (netAddress.length > 30) {
        alert("网址长度过长");
        document.CompanyRegist2Form.workScope.focus();
        return false;
    }
			...
			<div id="content">
				...
				<div class="formdiv" style="margin-top: 0; padding-bottom: 0; border-bottom: 0;">
					<ul id="list1">
						...
						<li>
							<a href="#"
								onclick="redirect('${ctx}/companyPubJob.do?method=showPubJob')">&equiv;&nbsp;
								企业招聘信息 </a>
						</li>
				...
				<DIV class="formdiv"
					...
					<html:form action="/companyRegist2.do?method=companyRegist2"
						...
						<table  class="finktable" id="grzpjl" summary="企业招聘信息">
							...
							<tr>
								...
								<td width="270" align="left" id="123" title="请选择企业性质">
