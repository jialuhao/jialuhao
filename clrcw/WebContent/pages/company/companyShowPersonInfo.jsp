											...
											<tr>
												...
												<table width="100%" border="0" align="center"
													...
													<tr>
														...
														<td width="25%" class="font5" bgcolor="#FFFFFF" align="center"><bean:write
		...
		<logic:present name="isNo">
			<logic:notEqual name="isNo" value="1">
				...
				<td height="40" align="center"><a
					href="${ctx}/compShowPersonInfo.do?method=join&ResumeId=${applyJob.personCode.id}"
