...
function change(s_id){
    ...
    document.form1.action = "${ctx}/companySPerson.do?method=showOtherPage";
    document.form1.submit();
}
function search2(){
			...
			<div id="content">
				...
				<DIV class="formdiv"
					...
					<ul id="list1">
						...
						<li  class="liH1">
							<a href="${ctx}/companySPerson.do?method=showAll" style="color: #BD0403;">&equiv;&nbsp;人才搜索</a>
						</li>
						<li>
									...
									<TABLE class="finktable" summary="人才搜索" width="100%"
										...
										<%
											String search = (String) request.getAttribute("search");
												...
												String workstate = (String) request.getAttribute("workstate");
										%>
										<TBODY>
											<tr>
												<td>
											...
											<tr>
												...
												<td>
													<select name="area" id="area" title="请选择户籍">
														<option value="" selected>
															全部
														</option>
