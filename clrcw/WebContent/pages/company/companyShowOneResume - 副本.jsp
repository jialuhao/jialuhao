...
<table width="656" border="0" align="center" cellpadding="0"
								...
								<table width="110" border="0" cellpadding="0" cellspacing="1"
									...
									<tr>
										<td height="130" bgcolor="#FFFFFF"><logic:present
											name="resume" property="fkPersonImage">
											<html:img action="/showPhoto.do?method=show" paramId="id"
												paramName="resume" paramProperty="fkPersonImage.id"
												width="110" height="130" />
										</logic:present> <logic:notPresent name="resume" property="fkPersonImage">
								...
								<table width="100%" border="0" align="center" cellpadding="0"
									...
									<logic:present name="resume">
										...
										<tr>
											...
											<td bgcolor="#FFFFFF" class="font5"><bean:write
												name="resume" property="school" /></td>
											<td><span class="fontview">所学专业：</span></td>
											<td bgcolor="#FFFFFF" class="font5"><bean:write
												name="resume" property="specialty" /></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td bgcolor="#FFFFFF" class="font5"><bean:write
												name="resume" property="lang2" /></td>
											<td><span class="fontview">残疾类别：</span></td>
											<td bgcolor="#FFFFFF" class="font5"><bean:write
												name="resume" property="level2" /></td>
										</tr>
									</logic:present>
				...
				<table width="598" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="5"
							...
							<tr>
								<td valign="top"><logic:present name="resumeB">
										...
										<table width="97%" border="0" align="center" cellpadding="0"
											...
											<tr>
												...
												<table width="100%" border="0" align="center"
													...
													<tr>
														<td width="120" class="fontview"><bean:write
															name="resume2" property="startTime" />-<bean:write
															name="resume2" property="endTime" /></td>
														<td bgcolor="#FFFFFF" class="font5"><bean:write
															name="resume2" property="workUnit" /></td>
														<td width="150" class="fontview"><bean:write
								...
								</logic:present> <logic:notPresent name="resumeB">
					...
					<tr>
						...
						<table width="100%" border="0" align="center" cellpadding="5"
							...
							<logic:present name="resume">
								...
								<tr>
									<td valign="top" class="font5"><bean:write name="resume"
										property="introSelf" /></td>
								</tr>
							</logic:present>
						</table>
						<table width="100%" border="0" align="center" cellpadding="5"
									...
									<logic:present name="resume">
										<tr>
											...
											<td width="34%" bgcolor="#FFFFFF" class="font5"><bean:write
												name="resume" property="address" /></td>
									...
									<logic:iterate id="job" name="applyJob"
										...
										<table width="100%" border="0" align="center" cellpadding="0"
											...
											<tr>
												...
												<td width="34%" bgcolor="#FFFFFF" class="font5"><bean:write
													name="job" property="postCode.postName" /></td>
												<td width="16%"><span class="fontview">欲从事职位：</span></td>
												<td width="34%" bgcolor="#FFFFFF" class="font5"><bean:write
													name="job" property="jobCode.jobName" /></td>
											</tr>
											<tr>
												<td><span class="fontview">曾从事本职位：</span></td>
												<td bgcolor="#FFFFFF" class="font5"><bean:write
													name="job" property="workYear" />年</td>
												<td><span class="fontview">期望月薪(税前)：</span></td>
												<td bgcolor="#FFFFFF" class="font5"><bean:write
													name="job" property="salary" /></td>
											</tr>
											<tr>
	...
	<tr>
		<td><img src="<%=request.getContextPath()%>/images/view_12.gif"
			alt="" width="656" height="70" border="0" usemap="#Map" /></td>
	</tr>
	<tr>
		<td height="8"></td>
	</tr>
	<tr>
		...
		<logic:present name="sta">
			<logic:equal name="sta" value="0">
				<td height="40" align="center"><html:link
					href="${ctx}/companyResume.do?method=contact" styleClass="d">
					<span class="font10">[建立联系]</span>
				</html:link>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="#"
					Class="d" onClick="history.back();return false;"> <span
					class="font10">[返回]</span></a></td>
			</logic:equal>
			<logic:notEqual name="sta" value="0">
				<td height="40" align="center"><a href="#" Class="d"
					onClick="history.back();return false;"> <span class="font10">[返回]</span></a>
			</logic:notEqual>
		</logic:present>
