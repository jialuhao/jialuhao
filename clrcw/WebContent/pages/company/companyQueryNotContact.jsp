...
function del(id){
    ...
    if (b) {
        ...
        document.form1.action = "${ctx}/companyQueryNotContact.do?method=delOneResume";
...
function change(s_id){
    ...
    document.form1.action = "${ctx}/companyQueryNotContact.do?method=comOtherPage";
    document.form1.submit();
}
function checkresume(a,b,c){
if(c){
window.location.href="${ctx}/companyQueryNotContact.do?method=showOneResume&userKeyId="+a+"&compResumekeyId="+b}
else{
									...
									<logic:iterate name="allResume" id="jobInfo"
										...
										<tr>
											...
											<td align="center">
												<a
													href="#"
												onclick="checkresume('${jobInfo.pkResume.user.id}','${jobInfo.id}',${jobInfo.reg})"	class="list"> 查看</a>&nbsp;
