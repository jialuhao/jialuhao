...
<% List list=(List)request.getSession().getAttribute("compservice");
							String otherwhy="";
							if(list!=null&&list.size()>0){
							CompService compservice1 = (CompService) list.get(0);
							 otherwhy=compservice1.getOtherwhy();
             if(otherwhy==null){
             otherwhy="";
             }
				}	%>		
...
function add(){
        var newTR =document.getElementById("testTable").insertRow(document.getElementById("testTable").rows.length);  
           ...
           newNameTD.innerHTML = "<input type='text' id='snumber2' name='snumber2' style='width: 100px'/>";  
          newNameTD.align = "center";
 ...
 j++;
        var newTR =document.getElementById("table").insertRow(document.getElementById("table").rows.length); 
          ...
          newNameTD.align = "center";
           var newNameTD = newTR.insertCell(1);  
           newNameTD.innerHTML = "<input type='text' id='cardnumber"+j+"' name='cardnumber2'  style='width: 170px'/> <input type='button'  value='查询' class='button' onclick='querymessage("+j+")'/>";  
           newNameTD.align = "center";
            var newNameTD = newTR.insertCell(2);  
           newNameTD.innerHTML = "<input type='text' id='commedname"+j+"' name='commedname2'  style='width: 100px'/>";  
           newNameTD.align = "center";
           var newNameTD = newTR.insertCell(3);  
           newNameTD.innerHTML =  "<input type='text' id='commedlevel"+j+"' name='commedlevel2'  style='width: 100px'/>";  
         newNameTD.align = "center";
           var newNameTD = newTR.insertCell(4);  
           newNameTD.innerHTML = "<input type='text' id='commedphone"+j+"'  name='commedphone2'  style='width: 130px'/>";  
            newNameTD.align = "center";
            var newNameTD = newTR.insertCell(5);  
 ...
 // var cardnumber=document.getElementById("cardnumber"+a).value();
  //document.getElementById("snumber").value=cardnumber;
  //document.myform.action="${ctx}/admin/findAllpublishJob.do?method=querymessage";
  //${ctx}/admin/findAllpublishJob.do?method=querymessage
  //${ctx}/servlet/getUserinfoByIdcard
...
<body >
	...
	cellspacing="0" bgcolor="#cccccc" summary="企业招聘信息" >
<tr><td colspan="7">
							 <%String flag=(String)request.getSession().getAttribute("flag"); %>
			 是否招到合适人员：
				<select id="validflag" name="validflag" onchange="javascript:showOrHide(this);" >
					<option value="">--请选择--</option>  
					<option value="3" <%if(flag.equals("3")||flag.equals("1")){ %>selected="selected"<%}%>>招聘成功</option>  
  					<option value="2" <%if(flag.equals("2")){ %>selected="selected"<%}%>>招聘失败</option>
    			</select>
							</td>
							</tr>
							<tr>
						...
						.getInstance().getTime())%>"/>
							...
							<div style="width:100%;height:15px;"></div>
							 <table width="100%"  border="0" align="center" cellpadding="0"
	cellspacing="0" bgcolor="#cccccc" id="table" >
							<tr >
	...
	cellspacing="1" bgcolor="#cccccc" id="testTable">
             ...
             otherwhy="";
						...
						if(list!=null&&list.size()>0){
							...
							String remark=compservice.getRemark();
							if(remark==null){
							remark="";
							}
							 %>
							<tr>
								...
								<td align="center" >
										<input type="text"  name="sname2" value="<%=compservice.getName()%>" style='width: 100px'/>
								</td>
								<td align="center" >
										<input type="text"  name="snumber2" value="<%=compservice.getNumber()%>" style='width: 100px'/>
								</td>
								<td align="center" >
										<input type="text"  name="register2" value="<%=compservice.getHouse()%>" style='width: 100px'/>
								</td>
								<td align="center" >
										<input type="text"  name="sphone2" value="<%=compservice.getPhone()%>" style='width: 100px'/>
								</td>
								<td align="center" >
										<input type="text"  name="sjob2" value="<%=compservice.getWorkname()%>" style='width: 100px'/>
								</td>
								
								<td align="center" >
										<input type="text"  name="remark2" value="<%=remark%>" style='width: 100px'/>
								</td>
								<td align="center" >
	...
	cellspacing="1" bgcolor="#cccccc">
							...
							<tr>
								<td width="1066" style="text-align: left;" >
									...
									岗位调整
									<input type="checkbox" onclick="aaaaa()" name="losewhyobj" id="losewhyobj3" value="3" />
									其它
...
if(list!=null&&list.size()>0){
 compservice = (CompService) list.get(0);} %>
...
document.myform.action="${ctx}/admin/findAllpublishJob.do?method=saveserviceJob";
