...
window.location.href="${ctx}/admin/aglientapply.do?method=showResume&id="+s_id;
...
%>
              ...
              <li> <a href="${ctx}/personShowCompInfo.do?method=showCompInfo" >8. 企业招聘意向</a></li-->
				...
				<DIV class="formdiv"
					...
					<form action="${ctx}/admin/aglientapply.do?method=delResume" name="form1"
						method="POST">
						<table class="finktable" id="jbqk" summary="个人招聘信息">
							...
							<tr>
								...
								<td width="148" style="color: #000000; font-size: 12px;"
									nowrap="nowrap" align="center">
									<a href="#" onClick="edit('<%=personResumeB.getId()%>')"
										
										class="tabBtn">编辑</a>
									<a href="#" onClick="del('<%=personResumeB.getId()%>')"
										class="tabBtn">删除</a>
								</td>
							</tr>
					...
					<form name="form2"
						action="${ctx}/admin/aglientapply.do?method=personRegist4_1"
