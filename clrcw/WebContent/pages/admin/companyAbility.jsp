...
function del(id){
    ...
    if (b) {
        ...
        document.form1.action = "${ctx}/admin/aglientpublish.do?method=delOneabResume";
...
function change(s_id){
    ...
    document.form1.action = "${ctx}/admin/aglientpublish.do?method=comOtherabPage";
    document.form1.submit();
}
...
window.location.href="${ctx}/admin/aglientpublish.do?method=showOneabResume&userKeyId="+a;
}
}
</script>
									...
									<TABLE class="finktable" summary="企业招聘信息" width="100%"
										...
										<TBODY>
											<tr>
												...
												<td>
													<%String years=(String)request.getSession().getAttribute("years");
													if(years==null)years="";
													%>
											...
											<tr>
												...
												<td>
													<select name="dkind" id="dkind" title="请选择残疾类别">
														...
														<%		String dkind=(String)request.getSession().getAttribute("dkind");
