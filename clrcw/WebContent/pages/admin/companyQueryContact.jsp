...
function del(id){
    ...
    if (b) {
        ...
        document.form1.action = "${ctx}/admin/aglientpublish.do?method=delOnequeryResume";
...
function change(s_id){
    ...
    document.form1.action = "${ctx}/admin/aglientpublish.do?method=comOtherqueryPage";
    document.form1.submit();
}
								...
								<td height="40" colspan="7">
									<TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td width="25%">
												<a
													href="${ctx}/admin/aglientpublish.do?method=showCompResume"
													class="d">未读简历 </a>&nbsp;&nbsp;&nbsp;&nbsp;
													<a
													href=""
