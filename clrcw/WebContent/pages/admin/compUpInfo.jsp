...
<%String compname=(String)request.getSession().getAttribute("compname"); %>
			<div id="content">
				...
				<DIV class="formdiv"
					...
					<ul id="list1">
						<li class="liH1">
							<a href="${ctx}/admin/aglientpublish.do?method=companyShowInfo"
								style="color: #BD0403;">&equiv;&nbsp;企业基本情况</a>
						</li>
						<li>
							<a href="#"
								onclick="redirect('${ctx}/admin/aglientpublish.do?method=showPubJob')">&equiv;&nbsp;企业招聘信息
							</a>
						</li>
						<li>
				...
				<DIV class="formdiv"
					...
					<form action="${ctx}/admin/aglientpublish.do?method=update" method="post"
						onsubmit="return checkform()" name="CompanyRegist2Form">
							...
							<tr>
								...
								<td width="270">
									<input type="text" title="请输入经营范围,长度为1-25字符之间" name="workScrope"
										id="workScrope" class="input3" value="${compInfo.workScrop}" />
									*
								</td>
								<td width="100" class="black">
