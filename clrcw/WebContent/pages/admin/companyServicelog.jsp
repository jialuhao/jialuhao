...
<%String compname=(String)request.getSession().getAttribute("compname"); %>
			...
			<div id="content">
				...
				<DIV class="formdiv"
					...
					<form action="${ctx}/admin/aglientpublish.do?method=saveServicelog" 
						method="post" name="myform" id="myform">
						<font face="Agency FB"><input type="hidden" name="sname" id="sname"><input type="hidden" name="disnumber" id="disnumber"><input type="hidden" name="phone" id="phone"><input type="hidden" name="house" id="house"><input type="hidden" name="workname" id="workname"><input type="hidden" name="remark" id="remark"><input type="hidden" name="losewhyobj" id="losewhyobj"> 
			...
			<div id="a" style="display:block">
    			...
    			<tr class="trcolor">
								...
								<td class="tdFormInput" align="center" width="50%" colspan="7">
									<div align="center">
										<font face="Agency FB"><strong>录用名单</strong></font>
									</div>
								</td>
							</tr>
							<tr>
								<td align="center" ><font face="Agency FB"> 
									姓名 
								</font></td>
								<td align="center" ><font face="Agency FB"> 
									残疾证号 
							...
							<tr>
								<td class="tdFormInput" >
									<font face="Agency FB"><input type="text" id="name2" name="name2" style="width: 100px;"></font>
								</td>
							<td class="tdFormInput" >
									<font face="Agency FB"><input type="text" id="disnumber2" name="disnumber2" style="width: 100px;"></font>
								</td>
							<td class="tdFormInput" >
									<font face="Agency FB"><input type="text" id="house2" name="house2" style="width: 100px;"></font>
								</td>
								
								<td class="tdFormInput" >
									<font face="Agency FB"><input type="text" id="phone2" name="phone2" style="width: 100px;"></font>
								</td>
								<td class="tdFormInput" >
									<font face="Agency FB"><input type="text" id="workname2" name="workname2" style="width: 100px;"></font>
								</td>
								<td class="tdFormInput" >
									<font face="Agency FB"><input type="text" id="remark2" name="remark2" style="width: 100px;"></font>
								</td>
								<td class="tdFormInput"  align="center"><font face="Agency FB"><input type="button" value="添加" class="button" onclick="add()"></font></td>
							</tr>
						...
						<table class="finktable" id="grzpjl" summary="企业招聘信息"
							...
							<tr>
								<td width="100" style="text-align: left;">
									...
									<font face="Agency FB"><input type="button" value="提交" onclick="javascript:chekmessage()"> 
									<input type="button" onclick="history.go(-1)" value="返回"><br></font>
