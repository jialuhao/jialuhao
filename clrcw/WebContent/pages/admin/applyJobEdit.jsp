...
$(function(){
	...
	title: '选择职业',
	lock: true,
    content: 'url:/clrcw/showJoball.do?method=showJobAll&jobid='+$("#job").val()
	});
});
...
$(function(){
	...
	title: '选择职业',
	lock: true,
    content: 'url:/clrcw/showQuyuall.do?method=showQuyuAll&quyu='+$("#workyears").val()
	});
});
...
%>
				...
				<DIV class="formdiv"
					...
					<form name="form2"
						action="${ctx}/admin/aglientapply.do?method=applyJobEdit" method="post"
						...
						<TABLE class="finktable" id="jbqk" width="100%" border="0"
							...
							<%
								ApplyJobInfo applyJobInfo = (ApplyJobInfo) request.getSession()
											.getAttribute("apply");
							%>
							<tr>
