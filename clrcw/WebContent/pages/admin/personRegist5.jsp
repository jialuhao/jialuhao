...
%>
				...
				<DIV class="formdiv"
					...
					<form name="form1" action="${ctx}/admin/aglientapply.do?method=saveIntro"
						...
						<TABLE class="finktable" id="jbqk" summary="个人招聘信息" width="100%"
							...
							<%
								String interests = request.getSession().getAttribute("interests") + "";
							%>
							<tr>
							...
							<tr>
								<%
									String ttt = request.getSession().getAttribute("intro") + "";
								%>
								<td width="146" valign="top" class="black">
									<label for="intro">
										自我评价：
