...
function checkform(){ 
	...
	if(compName.length<3||compName.length>40) {18612730136
...
fax = document.getElementById("fax").value;
    ...
    if ((fax.search(/(^[0-9]{3,4}\-[0-9]{3,8}$)|(^[0-9]{3,8}$)|(^\([0-9]{3,4}\)[0-9]{3,8}$)|(^0{0,1}13[0-9]{9}$)|(^0{0,1}15[0-9]{9}$)|(^0{0,1}18[0-9]{9}$)/)<0)&&fax.length>0) {
      ...
      var local = document.form1.uploadphoto1.value;
...
var local2 = document.form1.uploadphoto2.value;
		...
		<div id="main">
			...
			<div id="content">
				...
				<DIV class="formdiv"
					...
					<form name="form1"
						action="${ctx}/admin/aglientpublish.do?method=companyRegist1"
...
<TR>
							...
							<TR>
								...
								<TD>
									<INPUT name="netAddress" title="请输入长度30以内网址" id="netAddress" type="text">
									<FONT color="#333333" style="font-size: 12px;">
										请输入长度30以内的网址。</FONT>
								</TD>
							</TR><TR>
								...
								<TD>
									<INPUT name="compIntro" title="请输入企业介绍" id="compIntro" type="text">
									<FONT color="#333333" style="font-size: 12px;">
										*请输入企业介绍。</FONT>
								</TD>
							</TR>
							<TR>
								...
								<TD align="left">
									...
									<INPUT name="uploadphoto1" title="请选择照片" id="uploadphoto"
										type="file" size="35">
									<p style="color: #F30; font-size: 12px;">
										(上传的图像必须小于200K，支持JPEG,JPG,GIF格式 )
									</p>
								</TD>
							</TR>
							...
							<TR>
								...
								<TD align="left">
									...
									<INPUT name="uploadphoto2" title="请选择照片" id="uploadphoto"
										type="file" size="35">
									<p style="color: #F30; font-size: 12px;">
										(上传的图像必须小于200K，支持JPEG,JPG,GIF格式 )
									</p>
