					...
					<div class="formdiv">
						...
						<TABLE class="finktable" id="form_1" width="100%" border="0"
							...
							<tr>
								...
								<td class="black">
									<%
										if ("0".equals(personResume.getDkind())) {
									%>不限<%
										}
									%>
									<%
										if ("1".equals(personResume.getDkind())) {
									%>视力<%
										}
									%>
									<%
										if ("2".equals(personResume.getDkind())) {
									%>听力<%
										}
									%>
									<%
										if ("3".equals(personResume.getDkind())) {
									%>语言<%
										}
									%>
									<%
										if ("4".equals(personResume.getDkind())) {
									%>智力<%
										}
									%>
									<%
										if ("5".equals(personResume.getDkind())) {
									%>肢体<%
										}
									%>
									<%
										if ("6".equals(personResume.getDkind())) {
									%>精神<%
										}
									%>
									<%
										if ("7".equals(personResume.getDkind())) {
									%>综合<%
										}
									%>
								</td>
						...
						<TABLE class="finktable" id="form_1" width="100%" border="0"
							...
							<tr align="center">
										<td height="40" align="center">
											<a
												href="${ctx}/admin/aglientpublish.do?method=join&ResumeId=<%=personResume.getUser().getId()%>"
												styleClass="d">  
												<span class="font10">[放入人才库]  </span>
											</a>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
