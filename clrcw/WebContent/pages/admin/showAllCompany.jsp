...
function change(s_id){
    ...
    document.forms[0].action="${ctx}/admin/showAllCompany.do?method=nextShowAllCompany";
	document.forms[0].submit();
}
function search(){
 	   document.forms[0].action="${ctx}/admin/showAllCompany.do?method=showAllCompany";
       document.forms[0].submit();
 }
function showbespeak(s_id){
	document.form1.userId.value=s_id;
	document.form1.action="${ctx}/admin/showAllCompany.do?method=showOneCompany";
	document.form1.submit();
}
function hasSelect(){
...
<jsp:param name="contentTitle" value="已审核企业用户管理"/>
</jsp:include>
...
<table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#cccccc">
         ...
         <tr style="height: 20px">
          ...
          <!--<input type="button" style="width: 75px;border: 0px;" value="禁用" onclick="batch_del()"/>
      	 --></td>
 	 </tr>
  </table>
...
<table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#cccccc">
  <tr>
    <td height="30" colspan="7" bgcolor="#FFFFFF" class="font5">&nbsp;<a href="#">· </a>
	<a href="${ctx}/admin/showAllBespeak.do?method=showAllBespeak">待审核企业</a>&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="${ctx}/admin/showAllCompany.do?method=showAllCompany"  class="f2">已审核企业</a>&nbsp;&nbsp;&nbsp;&nbsp;
	</td>
  </tr>
  <tr><!--
    ...
    <td width="12%" align="center" bgcolor="#FFF7F0" class="font5">审核状态</td>
   ...
   <%
	...
	String state=bespeak.getCompStatus();
	if(state.equals("1")){
	state="审核未通过";
  ...
  <tr style="height: 20px">
        ...
        <td align="center" bgcolor="#FFFFFF" class="font5"><%=state%></td>
	...
	<%
		...
		%><font class="font3"> 没有已审核企业信息!</font><%
		}
	%>
  <%
		if (pagenum == pc && pc != 0) {
